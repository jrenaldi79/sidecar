/**
 * OpenCode HTTP API utilities.
 *
 * Shared between electron/summary.js and src/mcp-server.js.
 * Makes HTTP requests to the local OpenCode server.
 *
 * @module utils/opencode-api
 */
